...
public sealed class HrmStep158PolishTests : IDisposable
{
    private readonly AppDbContext _db;
    private readonly HrmStep158Service _svc;
    private readonly Guid _tenant = Guid.NewGuid();
    private readonly Guid _employeeId = Guid.NewGuid();
    private readonly Guid _workShiftId = Guid.NewGuid();
    private readonly Guid _payrollPeriodId = Guid.NewGuid();

    public HrmStep158PolishTests()
    {
        var opts = new DbContextOptionsBuilder<AppDbContext>()
            .UseInMemoryDatabase("hrm-step158-" + Guid.NewGuid())
            .Options;
        ...
        _svc = new HrmStep158Service(_db);
    }
