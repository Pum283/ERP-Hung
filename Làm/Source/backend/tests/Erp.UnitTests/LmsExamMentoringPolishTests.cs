...
public sealed class LmsExamMentoringPolishTests : IDisposable
{
    private readonly AppDbContext _db;
    private readonly LmsExamMentoringService _svc;
    ...
    public LmsExamMentoringPolishTests()
    {
        var opts = new DbContextOptionsBuilder<AppDbContext>()
            .UseInMemoryDatabase("lms-exam-mentoring-" + Guid.NewGuid())
            .Options;
        ...
        _svc = new LmsExamMentoringService(_db);
    }
