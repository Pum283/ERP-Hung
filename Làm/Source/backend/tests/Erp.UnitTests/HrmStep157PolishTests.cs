...
public sealed class HrmStep157PolishTests : IDisposable
{
    private readonly AppDbContext _db;
    private readonly HrmStep157Service _svc;
    ...
    public HrmStep157PolishTests()
    {
        var opts = new DbContextOptionsBuilder<AppDbContext>()
            .UseInMemoryDatabase("hrm-step157-" + Guid.NewGuid())
            .Options;
        ...
        _svc = new HrmStep157Service(_db);
    }
