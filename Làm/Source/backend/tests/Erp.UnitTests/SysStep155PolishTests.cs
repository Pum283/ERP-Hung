...
public sealed class SysStep155PolishTests
{
    private static (AppDbContext db, SysStep155Service svc, Guid tenantId) Create(string name)
    {
        ...
        db.SaveChanges();
        return (db, new SysStep155Service(db), tenantId);
    }
