...
public sealed class SysStep153PolishTests
{
    ...
    private static (AppDbContext db, SysStep153Service svc, Guid tenantId) Create(string dbName)
    {
        ...
        var svc = new SysStep153Service(db, jwt, new DummyScope(), platform, new SysStep154Service(db), config);
