...
public sealed class HrmOrgDepartmentPolishTests : IDisposable
{
    private readonly AppDbContext _db;
    private readonly HrmOrgDepartmentService _svc;
    private readonly Guid _tenant = Guid.NewGuid();
    private readonly Guid _orgUnit = Guid.NewGuid();
    private readonly Guid _employeeId = Guid.NewGuid();

    public HrmOrgDepartmentPolishTests()
    {
        var opts = new DbContextOptionsBuilder<AppDbContext>()
            .UseInMemoryDatabase("hrm-org-department-" + Guid.NewGuid())
            .Options;
        ...
        _svc = new HrmOrgDepartmentService(_db);
    }
