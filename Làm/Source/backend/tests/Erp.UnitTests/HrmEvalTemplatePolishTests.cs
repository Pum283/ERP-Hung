...
public sealed class HrmEvalTemplatePolishTests : IDisposable
{
    private readonly AppDbContext _db;
    private readonly HrmEvalTemplateService _svc;
    ...
    public HrmEvalTemplatePolishTests()
    {
        var opts = new DbContextOptionsBuilder<AppDbContext>()
            .UseInMemoryDatabase("hrm-eval-template-" + Guid.NewGuid())
            .Options;
        ...
        _svc = new HrmEvalTemplateService(_db);
    }
