...
public sealed class Step163PolishTests : IDisposable
{
    private readonly AppDbContext _db;
    private readonly Step163Service _svc;
    ...
    public Step163PolishTests()
    {
        var opts = new DbContextOptionsBuilder<AppDbContext>()
            .UseInMemoryDatabase("step163-" + Guid.NewGuid())
            .Options;
