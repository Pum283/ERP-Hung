...
public sealed class LmsEngageCertPolishTests : IDisposable
{
    private readonly AppDbContext _db;
    private readonly LmsEngageCertService _svc;
    ...
    public LmsEngageCertPolishTests()
    {
        var opts = new DbContextOptionsBuilder<AppDbContext>()
            .UseInMemoryDatabase("lms-engage-cert-" + Guid.NewGuid())
            .Options;
        ...
        _svc = new LmsEngageCertService(_db);
    }
