...
public sealed class Step160PolishTests : IDisposable
{
    private readonly AppDbContext _db;
    private readonly Step160Service _svc;
    private readonly Guid _tenant = Guid.NewGuid();
    private readonly Guid _employeeId = Guid.NewGuid();
    private readonly Guid _evaluationCycleId = Guid.NewGuid();
    private readonly Guid _courseId = Guid.NewGuid();

    public Step160PolishTests()
    {
        var opts = new DbContextOptionsBuilder<AppDbContext>()
            .UseInMemoryDatabase("step160-" + Guid.NewGuid())
            .Options;
