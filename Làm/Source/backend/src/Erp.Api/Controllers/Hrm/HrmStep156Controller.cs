...
[ApiController]
[Authorize]
[Route("api/hrm/step156")]
public sealed class HrmStep156Controller : ControllerBase
{
    private readonly IHrmStep156Service _svc;

    public HrmStep156Controller(IHrmStep156Service svc)
    {
        _svc = svc;
    }
