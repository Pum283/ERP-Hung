...
[ApiController]
[Authorize]
[Route("api/hrm/skill-qualifications")]
public sealed class HrmSkillQualificationController : ControllerBase
{
    private readonly IHrmSkillQualificationService _svc;

    public HrmSkillQualificationController(IHrmSkillQualificationService svc)
    {
        _svc = svc;
    }
