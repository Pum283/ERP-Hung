...
[ApiController]
[Authorize]
[Route("api/hrm-lms/eval-catalog")]
public sealed class HrmLmsEvalCatalogController : ControllerBase
{
    private readonly IHrmLmsEvalCatalogService _svc;

    public HrmLmsEvalCatalogController(IHrmLmsEvalCatalogService svc)
    {
        _svc = svc;
    }
