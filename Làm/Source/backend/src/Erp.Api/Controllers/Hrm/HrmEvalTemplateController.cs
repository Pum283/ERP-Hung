...
[ApiController]
[Authorize]
[Route("api/hrm/eval-templates")]
public sealed class HrmEvalTemplateController : ControllerBase
{
    private readonly IHrmEvalTemplateService _svc;

    public HrmEvalTemplateController(IHrmEvalTemplateService svc)
    {
        _svc = svc;
    }
