...
[ApiController]
[Authorize]
[Route("api/hrm/shift-import")]
public sealed class HrmShiftImportController : ControllerBase
{
    private readonly IHrmShiftImportService _svc;

    public HrmShiftImportController(IHrmShiftImportService svc)
    {
        _svc = svc;
    }
