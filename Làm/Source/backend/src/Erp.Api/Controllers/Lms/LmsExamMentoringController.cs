...
[ApiController]
[Authorize]
[Route("api/lms/exam-mentoring")]
public sealed class LmsExamMentoringController : ControllerBase
{
    private readonly ILmsExamMentoringService _svc;

    public LmsExamMentoringController(ILmsExamMentoringService svc)
    {
        _svc = svc;
    }
