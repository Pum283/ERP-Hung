...
/// <summary>SSO / Field ACL / Config versions / Push devices (UC_SYS_009, 031, 058, 062).</summary>
[ApiController]
[Authorize]
[Route("api/sys")]
public sealed class SysSsoFieldConfigPushController : ControllerBase
{
    private static readonly Guid DefaultTenantId = Guid.Parse("11111111-1111-1111-1111-111111111111");

    private readonly ISysSsoFieldConfigPushService _svc;

    public SysSsoFieldConfigPushController(ISysSsoFieldConfigPushService svc) => _svc = svc;
