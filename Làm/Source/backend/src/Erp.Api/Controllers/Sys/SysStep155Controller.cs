...
[Authorize]
[Route("api/sys")]
public sealed class SysStep155Controller : ControllerBase
{
    private static readonly Guid DefaultTenantId = Guid.Parse("11111111-1111-1111-1111-111111111111");

    private readonly ISysStep155Service _svc;

    public SysStep155Controller(ISysStep155Service svc) => _svc = svc;
