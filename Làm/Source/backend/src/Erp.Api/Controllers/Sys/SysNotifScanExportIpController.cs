...
[Authorize]
[Route("api/sys")]
public sealed class SysNotifScanExportIpController : ControllerBase
{
    private readonly ISysNotifScanExportIpService _svc;

    public SysNotifScanExportIpController(ISysNotifScanExportIpService svc) => _svc = svc;
