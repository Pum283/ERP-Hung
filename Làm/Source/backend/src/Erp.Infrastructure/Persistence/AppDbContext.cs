...
public sealed class AppDbContext : DbContext
{
    ...
    public DbSet<CrmCommissionPeriod> CrmCommissionPeriods => Set<CrmCommissionPeriod>();
    public DbSet<CrmSalesLeaderboardEntry> CrmSalesLeaderboardEntries => Set<CrmSalesLeaderboardEntry>();
    public DbSet<CrmScheduledReportExport> CrmScheduledReportExports => Set<CrmScheduledReportExport>();
    public DbSet<PosKitchenPrinterConfig> PosKitchenPrinterConfigs => Set<PosKitchenPrinterConfig>();
    public DbSet<PosCashDrawerConfig> PosCashDrawerConfigs => Set<PosCashDrawerConfig>();
    public DbSet<PosBarcodeScannerConfig> PosBarcodeScannerConfigs => Set<PosBarcodeScannerConfig>();
    public DbSet<PosProductAttributeModifier> PosProductAttributeModifiers => Set<PosProductAttributeModifier>();
    public DbSet<PosTimeSlotPriceRule> PosTimeSlotPriceRules => Set<PosTimeSlotPriceRule>();
    public DbSet<PosComboPromotionRule> PosComboPromotionRules => Set<PosComboPromotionRule>();
    public DbSet<PosOrderSplitMergeHistory> PosOrderSplitMergeHistories => Set<PosOrderSplitMergeHistory>();
    public DbSet<PosOrderTransferHistory> PosOrderTransferHistories => Set<PosOrderTransferHistory>();
    public DbSet<PosKitchenOrderTicket> PosKitchenOrderTickets => Set<PosKitchenOrderTicket>();
    public DbSet<PosShiftCashTransaction> PosShiftCashTransactions => Set<PosShiftCashTransaction>();
    public DbSet<PosShiftApprovalLog> PosShiftApprovalLogs => Set<PosShiftApprovalLog>();
    public DbSet<PosLoyaltyPointTransaction> PosLoyaltyPointTransactions => Set<PosLoyaltyPointTransaction>();
    public DbSet<PosStoreReplenishmentRequest> PosStoreReplenishmentRequests => Set<PosStoreReplenishmentRequest>();
    public DbSet<PosStoreQuickAudit> PosStoreQuickAudits => Set<PosStoreQuickAudit>();
    public DbSet<PurSupplierCategory> PurSupplierCategories => Set<PurSupplierCategory>();
    public DbSet<PurSupplierQualityEvaluation> PurSupplierQualityEvaluations => Set<PurSupplierQualityEvaluation>();
    public DbSet<PurSupplierLegalDocument> PurSupplierLegalDocuments => Set<PurSupplierLegalDocument>();
    public DbSet<PurPurchasePricelistValidity> PurPurchasePricelistValidities => Set<PurPurchasePricelistValidity>();
    public DbSet<PurPurchasePriceHistory> PurPurchasePriceHistories => Set<PurPurchasePriceHistory>();
    public DbSet<PurRfqMultiSupplier> PurRfqMultiSuppliers => Set<PurRfqMultiSupplier>();
    public DbSet<PurVendorQuotation> PurVendorQuotations => Set<PurVendorQuotation>();
    public DbSet<PurVendorPoConfirmation> PurVendorPoConfirmations => Set<PurVendorPoConfirmation>();
    public DbSet<PurVendorShipmentRejection> PurVendorShipmentRejections => Set<PurVendorShipmentRejection>();
    public DbSet<PurVendorReturn> PurVendorReturns => Set<PurVendorReturn>();
    public DbSet<PurDeliveryReceivingProtocol> PurDeliveryReceivingProtocols => Set<PurDeliveryReceivingProtocol>();
    public DbSet<PurVendorAdvancePayment> PurVendorAdvancePayments => Set<PurVendorAdvancePayment>();
    public DbSet<PurBlanketContract> PurBlanketContracts => Set<PurBlanketContract>();
    public DbSet<PurVendorOtdReport> PurVendorOtdReports => Set<PurVendorOtdReport>();
    public DbSet<PurRfqSavingsReport> PurRfqSavingsReports => Set<PurRfqSavingsReport>();
    public DbSet<InvProductMedia> InvProductMedias => Set<InvProductMedia>();
    public DbSet<InvProductBarcodeQr> InvProductBarcodeQrs => Set<InvProductBarcodeQr>();
    public DbSet<InvWarehouseBinLocation> InvWarehouseBinLocations => Set<InvWarehouseBinLocation>();
    public DbSet<InvCustomerReturnReceipt> InvCustomerReturnReceipts => Set<InvCustomerReturnReceipt>();
    public DbSet<InvLotSerialLabelPrint> InvLotSerialLabelPrints => Set<InvLotSerialLabelPrint>();
    public DbSet<InvTechnicalServiceDispatch> InvTechnicalServiceDispatches => Set<InvTechnicalServiceDispatch>();
    public DbSet<InvProjectDispatch> InvProjectDispatches => Set<InvProjectDispatch>();
    public DbSet<InvTransferApproval> InvTransferApprovals => Set<InvTransferApproval>();
    public DbSet<InvOneStepTransfer> InvOneStepTransfers => Set<InvOneStepTransfer>();
    public DbSet<InvSerialTrackingHistory> InvSerialTrackingHistories => Set<InvSerialTrackingHistory>();
    public DbSet<InvLotTraceability> InvLotTraceabilities => Set<InvLotTraceability>();
    public DbSet<InvStocktakeLocationGroup> InvStocktakeLocationGroups => Set<InvStocktakeLocationGroup>();
    public DbSet<InvStocktakeLock> InvStocktakeLocks => Set<InvStocktakeLock>();
    public DbSet<InvInternalIssueRequest> InvInternalIssueRequests => Set<InvInternalIssueRequest>();
    public DbSet<InvMaterialRequisition> InvMaterialRequisitions => Set<InvMaterialRequisition>();
    public DbSet<InvSlowMovingAnalysis> InvSlowMovingAnalyses => Set<InvSlowMovingAnalysis>();
    public DbSet<InvDispatchPurposeReport> InvDispatchPurposeReports => Set<InvDispatchPurposeReport>();
    public DbSet<LogDriverVehicle> LogDriverVehicles => Set<LogDriverVehicle>();
    public DbSet<LogFreightPricingRate> LogFreightPricingRates => Set<LogFreightPricingRate>();
    public DbSet<LogDeliveryZoneConfig> LogDeliveryZoneConfigs => Set<LogDeliveryZoneConfig>();
    public DbSet<LogDeliveryShift> LogDeliveryShifts => Set<LogDeliveryShift>();
    public DbSet<LogDeliveryTrip> LogDeliveryTrips => Set<LogDeliveryTrip>();
    public DbSet<LogProofOfDelivery> LogProofOfDeliveries => Set<LogProofOfDelivery>();
    public DbSet<LogRedeliveryRequest> LogRedeliveryRequests => Set<LogRedeliveryRequest>();
    public DbSet<LogRealtimeGpsPing> LogRealtimeGpsPings => Set<LogRealtimeGpsPing>();
    public DbSet<LogInternalTransferDelivery> LogInternalTransferDeliveries => Set<LogInternalTransferDelivery>();
    public DbSet<LogInternalDeliveryReconciliation> LogInternalDeliveryReconciliations => Set<LogInternalDeliveryReconciliation>();
    public DbSet<LogDriverProductivityReport> LogDriverProductivityReports => Set<LogDriverProductivityReport>();
    public DbSet<LogShippingCostAllocation> LogShippingCostAllocations => Set<LogShippingCostAllocation>();
    public DbSet<MfgRoutingStage> MfgRoutingStages => Set<MfgRoutingStage>();
    public DbSet<MfgShiftCapacity> MfgShiftCapacities => Set<MfgShiftCapacity>();
    public DbSet<MfgBomScrapAllowance> MfgBomScrapAllowances => Set<MfgBomScrapAllowance>();
    public DbSet<MfgBomCopyLog> MfgBomCopyLogs => Set<MfgBomCopyLog>();
    public DbSet<MfgDemandProductionPlan> MfgDemandProductionPlans => Set<MfgDemandProductionPlan>();
    public DbSet<MfgMaterialRequirementPlanning> MfgMaterialRequirementPlannings => Set<MfgMaterialRequirementPlanning>();
    public DbSet<MfgWorkshopShiftSchedule> MfgWorkshopShiftSchedules => Set<MfgWorkshopShiftSchedule>();
    public DbSet<MfgOperationProgressTracking> MfgOperationProgressTrackings => Set<MfgOperationProgressTracking>();
    public DbSet<MfgReworkWorkOrder> MfgReworkWorkOrders => Set<MfgReworkWorkOrder>();
    public DbSet<MfgOverheadCostAllocation> MfgOverheadCostAllocations => Set<MfgOverheadCostAllocation>();
    public DbSet<MfgCostVarianceAnalysis> MfgCostVarianceAnalyses => Set<MfgCostVarianceAnalysis>();
    public DbSet<MfgIncomingQcCriterion> MfgIncomingQcCriteria => Set<MfgIncomingQcCriterion>();
    public DbSet<MfgFinishedGoodsQcCheck> MfgFinishedGoodsQcChecks => Set<MfgFinishedGoodsQcCheck>();
    public DbSet<MfgInspectionLotDisposition> MfgInspectionLotDispositions => Set<MfgInspectionLotDisposition>();
    public DbSet<MfgDefectiveQuarantineHold> MfgDefectiveQuarantineHolds => Set<MfgDefectiveQuarantineHold>();
    public DbSet<MfgQualityPassYieldReport> MfgQualityPassYieldReports => Set<MfgQualityPassYieldReport>();
    public DbSet<MfgProductionBatchLot> MfgProductionBatchLots => Set<MfgProductionBatchLot>();
    public DbSet<MfgBatchProcessParameter> MfgBatchProcessParameters => Set<MfgBatchProcessParameter>();
    public DbSet<MfgPackagingLabelTag> MfgPackagingLabelTags => Set<MfgPackagingLabelTag>();
    public DbSet<MfgBlendingRecipeRatio> MfgBlendingRecipeRatios => Set<MfgBlendingRecipeRatio>();
    public DbSet<MfgOverallEquipmentEffectiveness> MfgOverallEquipmentEffectivenesses => Set<MfgOverallEquipmentEffectiveness>();
    public DbSet<FsmServicePriceRate> FsmServicePriceRates => Set<FsmServicePriceRate>();
    public DbSet<FsmTechnicianSkillCert> FsmTechnicianSkillCerts => Set<FsmTechnicianSkillCert>();
    public DbSet<FsmTerritoryCoverage> FsmTerritoryCoverages => Set<FsmTerritoryCoverage>();
    public DbSet<FsmWarrantyExpiryAlert> FsmWarrantyExpiryAlerts => Set<FsmWarrantyExpiryAlert>();
    public DbSet<FsmPeriodicMaintenanceContract> FsmPeriodicMaintenanceContracts => Set<FsmPeriodicMaintenanceContract>();
    public DbSet<FsmAutoDispatchRule> FsmAutoDispatchRules => Set<FsmAutoDispatchRule>();
    public DbSet<FsmJobExecutionChecklist> FsmJobExecutionChecklists => Set<FsmJobExecutionChecklist>();
    public DbSet<FsmJobPhotoAttachment> FsmJobPhotoAttachments => Set<FsmJobPhotoAttachment>();
    public DbSet<FsmSparePartReturn> FsmSparePartReturns => Set<FsmSparePartReturn>();
    public DbSet<FsmRepairCostRecord> FsmRepairCostRecords => Set<FsmRepairCostRecord>();
    public DbSet<FsmCustomerServiceFeedback> FsmCustomerServiceFeedbacks => Set<FsmCustomerServiceFeedback>();
    public DbSet<FsmReopenedTicketLog> FsmReopenedTicketLogs => Set<FsmReopenedTicketLog>();
    public DbSet<FsmFinanceCostTransfer> FsmFinanceCostTransfers => Set<FsmFinanceCostTransfer>();
    public DbSet<FsmEquipmentMaintenanceSchedule> FsmEquipmentMaintenanceSchedules => Set<FsmEquipmentMaintenanceSchedule>();
    public DbSet<FsmAutoDueMaintenanceTicket> FsmAutoDueMaintenanceTickets => Set<FsmAutoDueMaintenanceTicket>();
    public DbSet<FsmStandardMaintenanceChecklist> FsmStandardMaintenanceChecklists => Set<FsmStandardMaintenanceChecklist>();
    public DbSet<FsmMaintenanceExecutionReport> FsmMaintenanceExecutionReports => Set<FsmMaintenanceExecutionReport>();
    public DbSet<FsmSparePartLossWarning> FsmSparePartLossWarnings => Set<FsmSparePartLossWarning>();
    public DbSet<FsmOfflineSyncAuditLog> FsmOfflineSyncAuditLogs => Set<FsmOfflineSyncAuditLog>();
    public DbSet<FsmDailyExpenseSettlement> FsmDailyExpenseSettlements => Set<FsmDailyExpenseSettlement>();
    public DbSet<FsmFirstTimeFixRateReport> FsmFirstTimeFixRateReports => Set<FsmFirstTimeFixRateReport>();
    public DbSet<FsmWarrantyClaimSummaryReport> FsmWarrantyClaimSummaryReports => Set<FsmWarrantyClaimSummaryReport>();
    public DbSet<PjmAcceptanceChecklistTemplate> PjmAcceptanceChecklistTemplates => Set<PjmAcceptanceChecklistTemplate>();
    public DbSet<PjmGanttTimelineMilestone> PjmGanttTimelineMilestones => Set<PjmGanttTimelineMilestone>();
    public DbSet<PjmPlanChangeAuditLog> PjmPlanChangeAuditLogs => Set<PjmPlanChangeAuditLog>();
    public DbSet<PjmProjectTimesheetEntry> PjmProjectTimesheetEntries => Set<PjmProjectTimesheetEntry>();
    public DbSet<PjmBudgetOverrunWarning> PjmBudgetOverrunWarnings => Set<PjmBudgetOverrunWarning>();
    public DbSet<PjmSurveyChecklistItem> PjmSurveyChecklistItems => Set<PjmSurveyChecklistItem>();
    public DbSet<PjmInstallationChecklistItem> PjmInstallationChecklistItems => Set<PjmInstallationChecklistItem>();
    public DbSet<PjmHandoverChecklistItem> PjmHandoverChecklistItems => Set<PjmHandoverChecklistItem>();
    public DbSet<PjmSiteProtocolAttachment> PjmSiteProtocolAttachments => Set<PjmSiteProtocolAttachment>();
    public DbSet<PjmEngineeringChangeRequest> PjmEngineeringChangeRequests => Set<PjmEngineeringChangeRequest>();
    public DbSet<PjmChangeRequestApproval> PjmChangeRequestApprovals => Set<PjmChangeRequestApproval>();
    public DbSet<PjmPostProjectWarrantyCoverage> PjmPostProjectWarrantyCoverages => Set<PjmPostProjectWarrantyCoverage>();
    public DbSet<PjmResourceProductivityReport> PjmResourceProductivityReports => Set<PjmResourceProductivityReport>();
    public DbSet<FinCurrencyExchangeRate> FinCurrencyExchangeRates => Set<FinCurrencyExchangeRate>();
    public DbSet<FinCashFlowCategory> FinCashFlowCategories => Set<FinCashFlowCategory>();
    public DbSet<FinRecurringTemplateVoucher> FinRecurringTemplateVouchers => Set<FinRecurringTemplateVoucher>();
    public DbSet<FinOriginalVoucherAttachment> FinOriginalVoucherAttachments => Set<FinOriginalVoucherAttachment>();
    public DbSet<FinAdvanceSettlementRequest> FinAdvanceSettlementRequests => Set<FinAdvanceSettlementRequest>();
    public DbSet<FinCashVaultCountAudit> FinCashVaultCountAudits => Set<FinCashVaultCountAudit>();
    public DbSet<FinBankStatementImportRecord> FinBankStatementImportRecords => Set<FinBankStatementImportRecord>();
    public DbSet<FinArApOffsetSettlement> FinArApOffsetSettlements => Set<FinArApOffsetSettlement>();
    public DbSet<FinDebtDunningNotification> FinDebtDunningNotifications => Set<FinDebtDunningNotification>();
    public DbSet<FinBadDebtProvisionWriteOff> FinBadDebtProvisionWriteOffs => Set<FinBadDebtProvisionWriteOff>();
