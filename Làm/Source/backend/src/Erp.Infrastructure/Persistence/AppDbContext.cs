...
public sealed class AppDbContext : DbContext
{
    ...
    public DbSet<LmsVideoProtection> LmsVideoProtections => Set<LmsVideoProtection>();
    public DbSet<LmsSurvey> LmsSurveys => Set<LmsSurvey>();
    public DbSet<LmsSurveyResponse> LmsSurveyResponses => Set<LmsSurveyResponse>();
    public DbSet<LmsShiftTrainingGate> LmsShiftTrainingGates => Set<LmsShiftTrainingGate>();
    public DbSet<LmsLearningPath> LmsLearningPaths => Set<LmsLearningPath>();
    public DbSet<LmsLearningPathItem> LmsLearningPathItems => Set<LmsLearningPathItem>();
    public DbSet<LmsUserLearningPath> LmsUserLearningPaths => Set<LmsUserLearningPath>();
    public DbSet<LmsAcknowledgement> LmsAcknowledgements => Set<LmsAcknowledgement>();
    public DbSet<LmsOverdueTrainingAlert> LmsOverdueTrainingAlerts => Set<LmsOverdueTrainingAlert>();
    public DbSet<LmsAiRecommendation> LmsAiRecommendations => Set<LmsAiRecommendation>();
    public DbSet<LmsAiQnaLog> LmsAiQnaLogs => Set<LmsAiQnaLog>();
    ...
    public DbSet<CrmPotentialScore> CrmPotentialScores => Set<CrmPotentialScore>();
    public DbSet<CrmOmnichannelConversation> CrmOmnichannelConversations => Set<CrmOmnichannelConversation>();
    public DbSet<CrmChatRoutingRule> CrmChatRoutingRules => Set<CrmChatRoutingRule>();
    public DbSet<CrmChatSlaAlert> CrmChatSlaAlerts => Set<CrmChatSlaAlert>();
    public DbSet<CrmCsatRating> CrmCsatRatings => Set<CrmCsatRating>();
    public DbSet<CrmOnlineOrderIntake> CrmOnlineOrderIntakes => Set<CrmOnlineOrderIntake>();
    public DbSet<CrmSalesTerritory> CrmSalesTerritories => Set<CrmSalesTerritory>();
    public DbSet<CrmVisitPlan> CrmVisitPlans => Set<CrmVisitPlan>();
    public DbSet<CrmVisitOutcome> CrmVisitOutcomes => Set<CrmVisitOutcome>();
    public DbSet<CrmVisitDemand> CrmVisitDemands => Set<CrmVisitDemand>();
    public DbSet<CrmOrderDocumentReconciliation> CrmOrderDocumentReconciliations => Set<CrmOrderDocumentReconciliation>();
    public DbSet<CrmOrderComplaint> CrmOrderComplaints => Set<CrmOrderComplaint>();
    public DbSet<CrmSalesContract> CrmSalesContracts => Set<CrmSalesContract>();
    public DbSet<CrmSalesContractAttachment> CrmSalesContractAttachments => Set<CrmSalesContractAttachment>();
    public DbSet<CrmCustomerCareSchedule> CrmCustomerCareSchedules => Set<CrmCustomerCareSchedule>();
    public DbSet<CrmLoyaltyProgram> CrmLoyaltyPrograms => Set<CrmLoyaltyProgram>();
    public DbSet<CrmRewardRedemption> CrmRewardRedemptions => Set<CrmRewardRedemption>();
    public DbSet<CrmCommissionRule> CrmCommissionRules => Set<CrmCommissionRule>();
