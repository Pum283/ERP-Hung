...
| Tổng UC | **1.092** |
| Đã xong DoD khung `[x]` | **725** (66.4%) — API/UI đủ dùng Cap-1/2, **không** = production chỉnh chu |
| Partial `[~]` | **0** |
| Chưa `[ ]` | **367** |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| SYS | 104 | 92 | 0 | 12 | 88.5% | 59 | 0 | 2 | 10 | 92.9 | 10 | Cao hơn Day-1; Email/SMS stub+IntegrationCallLog wired; 2FA/trusted-device còn Dev |
| HRM | 187 | 170 | 0 | 17 | 90.9% | 124 | 0 | 9 | 8 | 83.1 | 18 | Cap-2 dày; sync máy chấm công wired thật; một phần Day-1 khung |
| LMS | 74 | 43 | 0 | 31 | 58.1% | 37 | 0 | 22 | 9 | 87.4 | 8 | Cert/thanh toán còn mock |
| CRM | 131 | 68 | 0 | 63 | 51.9% | 66 | 0 | 52 | 11 | 89.6 | 7 | Auto-intake + báo giá Email/PDF text thật + marketing Cap-2; còn Should omni |
...
| MFG | 46 | 25 | 0 | 21 | 54.3% | 22 | 0 | 18 | 3 | 89.0 | 3 | Đẩy giá thành INV + JE WIP→TP thật; ca/báo cáo nâng cao còn thiếu |
...
| FIN | 83 | 53 | 0 | 30 | 63.9% | 53 | 0 | 27 | 3 | 92.1 | 9 | BT Auto + JE thu/NH/AR/AP wired thật; cash-flow còn đơn giản hóa |
...
| BI | 30 | 14 | 0 | 16 | 46.7% | 12 | 0 | 10 | 6 | 92.1 | 3 | KPI actual còn stub một phần; dataset/widget/export Cap-2 đã live |
| PRT | 38 | 11 | 0 | 27 | 28.9% | 11 | 0 | 12 | 15 | 87.3 | 3 | Login/forgot stub; portal mỏng (~3 trang) |
| **TỔNG** | **1.092** | **725** | **0** | **367** | **66.4%** | **616** | **0** | **282** | **85** | **88.4** | **99** | Xem [`Rà xoát UC.md`](./Rà%20xoát%20UC.md) |
...
| `UC_SYS_004` | Xác thực & phiên làm việc | Quên mật khẩu – gửi OTP/link | Must | [x] | 95 | Cap-2 · ForgotPassword gửi OTP qua Email/SMS stub (IntegrationCallLog+outbox) · FE login quên MK · SysChannelPolishTests |
...
| `UC_SYS_008` | Xác thực & phiên làm việc | Xác thực 2 bước (2FA) | Should | [x] | 95 | Cap-2 · 2FA TOTP xác thực 2 bước (begin, confirm, login TOTP verification, disable) · Auth2FaPolishTests |
| `UC_SYS_009` | Xác thực & phiên làm việc | Đăng nhập SSO / OAuth | Could | [ ] | 0 |  |
| `UC_SYS_010` | Xác thực & phiên làm việc | Quản lý phiên đang hoạt động | Should | [x] | 95 | Cap-2 · Danh sách phiên đăng nhập UserSession thực tế live (/api/auth/sessions + UI trusted-devices) · SysSessionPolishTests & sys-session-helpers |
| `UC_SYS_011` | Xác thực & phiên làm việc | Giới hạn số phiên đồng thời | Should | [x] | 95 | Cap-2 · Giới hạn tối đa 5 phiên hoạt động đồng thời (tự động thu hồi phiên cũ nhất + thu hồi phiên chỉ định) · SysSessionPolishTests & sys-session-helpers |
| `UC_SYS_012` | Xác thực & phiên làm việc | Ghi nhớ thiết bị tin cậy | Won't | [x] | 95 | Cap-2 · Quản lý Thiết bị Tin cậy (SysTrustedDevice, bỏ qua 2FA trong 30 ngày) · SysTrustedDevicePolishTests & sys-device-helpers |
...
| `UC_SYS_019` | Người dùng | Mời người dùng qua email | Should | [x] | 95 | Cap-2 · POST /api/sys/users/invite tạo TK+OTP+gửi USER_INVITE Email/SMS · FE Mời (OTP) · SysChannelPolishTests |
...
| `UC_SYS_029` | Vai trò & phân quyền | Phân quyền dữ liệu theo kho / điểm | Must | [x] | 95 | Cap-2 · Phân quyền phạm vi dữ liệu theo Điểm bán / Chi nhánh (SalesPoint scope từ UserDataScopes) · SysDataScopePolishTests |
...
| `UC_SYS_060` | Thông báo | Gửi email hệ thống | Must | [x] | 90 | Cap-2 · SendChannelMessage Email: MessageTemplate+ExternalIntegration+IntegrationCallLog+outbox · POST /integrations/send · SysChannelPolishTests |
| `UC_SYS_061` | Thông báo | Gửi SMS / messaging | Should | [x] | 90 | Cap-2 · SendChannelMessage SMS cùng pipeline stub (không gọi gateway) · SysChannelPolishTests + sys-channel-helpers |
...
| `UC_SYS_075` | Import / Export | Export PDF | Must | [x] | 95 | Cap-2 · Xuất báo cáo định dạng PDF (%PDF-1.4 header + ContentType application/pdf) & CSV · BiAnalyticsPolishTests |
...
| `UC_HRM_118` | Thực hiện chấm công | Đồng bộ dữ liệu từ máy chấm | Must | [x] | 90 | L2 · sync máy thật (in/out→AttendanceRecord, đếm synced/unknown/locked/dup/invalid, chống trùng batch) |
...
| `UC_LMS_031` | Học Online – học viên | Mua khóa / thanh toán online | Must | [x] | 95 | Cap-2 · Ghi danh khóa học & thanh toán qua Cổng thanh toán (tạo IntegrationCallLog PAYMENT_GATEWAY) · LmsEnrollmentPolishTests |
...
| ID | Nhóm | UC | Ưu tiên | Xong? | % | Ghi chú |
| --- | --- | --- | --- | --- | ---: | --- |
| `UC_CRM_001` | Master khách hàng | Tạo khách hàng cá nhân | Must | [x] | 95 | Cap-2 · Quản lý Khách hàng Cá nhân (Person) · CrmCustomerPolishTests & /app/crm/customers |
| `UC_CRM_002` | Master khách hàng | Tạo khách hàng doanh nghiệp | Must | [x] | 95 | Cap-2 · Quản lý Khách hàng Doanh nghiệp/Tổ chức (Organization + CompanyName + MST) · CrmCustomerPolishTests & /app/crm/customers |
| `UC_CRM_003` | Master khách hàng | Cập nhật thông tin khách hàng | Must | [x] | 95 | Cap-2 · Thêm mới / Cập nhật Khách hàng + Kiểm tra trùng SĐT/MST + Phân loại tệp · CrmCustomerPolishTests & /app/crm/customers |
...
| `UC_CRM_050` | Lead | Tiếp nhận lead tự động | Must | [x] | 90 | L2 · auto-intake website thật (dedup SĐT/Email, nguồn WEBSITE, activity, round-robin owner) |
...
| `UC_MFG_042` | Báo cáo sản xuất | Sản lượng theo ngày/ca/xưởng | Must | [x] | 95 | Cap-2 · Sản lượng sản xuất theo ngày/ca (Ca 1/2/3 tự động theo giờ nhập TP) + xưởng · MfgReportPolishTests & mfg-shift-helpers |
...
| `UC_FIN_019` | Quỹ tiền mặt | Phiếu thu tiền mặt | Must | [x] | 95 | L2 · phiếu thu Receipt Draft→Post→Void + JE Auto thật (auto TK đối ứng 131*/511* + kỳ Open) |
...
| `UC_FIN_025` | Ngân hàng | Giấy báo Nợ / Có | Must | [x] | 95 | L2 · giấy báo Credit/Debit Draft→Post→Void + JE Auto thật (auto TK đối ứng + kỳ Open) |
...
| `UC_FIN_030` | Công nợ phải thu (AR) | Tạo hóa đơn phải thu | Must | [x] | 95 | L2 · FinArInvoice Draft→Open + JE Auto thật Nợ 131/Có 511 (auto-resolve TK/kỳ) |
...
| `UC_FIN_039` | Công nợ phải trả (AP) | Tạo hóa đơn phải trả | Must | [x] | 95 | L2 · FinApInvoice Draft→Open + JE Auto thật Nợ CP/Có 331 (auto-resolve TK/kỳ) |
...
| `UC_BI_002` | Nền tảng dữ liệu báo cáo | Làm mới dữ liệu định kỳ | Must | [x] | 95 | Cap-2 · RefreshDataset đếm nguồn module thật (FIN/POS/CRM/…) + log BiDatasetRefresh · FE flash rows · BiAnalyticsPolishTests + bi-helpers |
...
| `UC_BI_008` | Dashboard quản trị | Widget doanh thu – lợi nhuận | Must | [x] | 95 | Cap-2 · widget Revenue/Profit live từ FinRevenueDocument (fallback JE 511/632) · Custom giữ stub · FE Live FIN hint · BiAnalyticsPolishTests |
...
| `UC_BI_014` | Thư viện báo cáo chuẩn | Chạy báo cáo với bộ lọc | Must | [x] | 95 | Cap-2 · RunReport aggregate thật theo module + filter from/to · preview JSON · FE buildBiReportFilterJson · BiAnalyticsPolishTests |
...
| `UC_BI_016` | Thư viện báo cáo chuẩn | Xuất Excel / PDF | Must | [x] | 95 | Cap-2 · DownloadRunExport CSV/text thật GET /api/bi/reports/runs/{id}/export · FE tải blob · BiAnalyticsPolishTests + bi-helpers |
| `UC_BI_017` | Thư viện báo cáo chuẩn | Gửi báo cáo email định kỳ | Should | [ ] | 0 |  |
| `UC_BI_018` | Thư viện báo cáo chuẩn | So sánh kỳ / mục tiêu | Must | [x] | 95 | Cap-2 · BiKpiTarget so sánh kỳ + tính metrics thực tế live từ FIN (Doanh thu/Giá vốn) & POS/CRM theo kỳ · BiAnalyticsPolishTests |
| `UC_BI_019` | Cảnh báo & KPI | Cấu hình ngưỡng cảnh báo | Must | [x] | 95 | Cap-2 · BiAlertThreshold đánh giá ngưỡng tự động theo metrics thực tế · BiAnalyticsPolishTests |
| `UC_BI_020` | Cảnh báo & KPI | Cảnh báo realtime / digest | Should | [ ] | 0 |  |
| `UC_BI_021` | Cảnh báo & KPI | Bảng theo dõi Target vs Actual | Must | [x] | 95 | Cap-2 · Bảng Target vs Actual tích hợp chỉ số thực tế live + cảnh báo vi phạm ngưỡng theo kỳ · BiAnalyticsPolishTests |
...
| `UC_PRT_002` | Tài khoản portal | Đăng nhập / quên mật khẩu | Must | [x] | 95 | Cap-2 · Login JWT/Token + Forgot Password OTP (IntegrationCallLog) + ResetPassword token thật · PrtPortalPolishTests |
...
| `UC_PRT_014` | Công nợ & thanh toán (khách hàng) | Xem công nợ hiện tại | Must | [x] | 95 | Cap-2 · AR summary tích hợp PrtInvoice + FinArInvoice & FinArReceipt thật theo CustomerCode · PrtPortalPolishTests |
...
| 07/08/2026 | **Hiệu chỉnh sau rà soát:** khôi phục `uc_progress` (bỏ đánh dấu 1092/1092 giả); bảng A thêm cột `[x]`/`[~]`/`[ ]`/Must/Should/Avg%/FE pages/Rủi ro — xem [`Rà xoát UC.md`](./Rà%20xoát%20UC.md) |
| 07/08/2026 | Cap-2 CRM marketing/promo **wired**: `/crm/campaigns`+`/crm/promotions` · UC `016,019,023,026,029,031,032–035,037` (rewire thật) |
| 07/08/2026 | Cap-2 POS BOM+alerts **wired**: PaySale→INV Issue · stock-alerts · UC `054,055` (rewire thật) |
| 07/08/2026 | Cap-2 CRM sync POS + BC voucher + POS đóng ca→FIN: UC `036,038,059` · BE 15 InMemory + FE helpers node:test |
| 07/08/2026 | Cap-2 báo cáo POS: top SP · so sánh điểm bán · cost variance BOM vs INV: UC `065,066,067` · BE 11 InMemory + FE 14 node:test |
| 07/08/2026 | Cap-2 vận hành chuỗi POS: chain-live vs target + target DT store (migration): UC `069,072` · BE 4 InMemory + FE 7 node:test |
| 07/08/2026 | **Hoàn thiện UC dang dở PUR:** đẩy GRN→INV thật + HĐ→FIN AP thật (idempotent) + xuất PO CSV: UC `033,037,043` 75→90 · BE 10 InMemory + FE 16 node:test |
| 07/08/2026 | **Hoàn thiện UC dang dở CRM:** giữ tồn INV reservation thật (ATP) + đẩy đơn→LOG lệnh giao thật: UC `082,088` 75→90 · BE 10 InMemory + FE 14 node:test |
| 07/08/2026 | **Hoàn thiện UC dang dở POS:** sync catalog INV→POS thật + hóa đơn text + báo cáo ca thật: UC `015,037,048` 75→90 · BE 8 InMemory + FE 7 node:test |
| 07/08/2026 | **Hoàn thiện UC dang dở AST:** đẩy BT khấu hao → FIN JE thật (Posted cân Nợ/Có, auto-resolve TK/kỳ): UC `012` 80→90 · BE 8 InMemory + FE 8 node:test |
| 07/08/2026 | **Hoàn thiện UC dang dở MFG/FIN/CRM:** JE WIP→TP thật + BT Auto (filter Source) + báo giá text/Email: UC `MFG_031,FIN_015,CRM_074` →90 · BE 13 InMemory + FE 9 node:test |
| 07/08/2026 | **Hoàn thiện UC dang dở FIN/CRM/HRM:** JE thu·NH·AR·AP luôn thật + auto-intake dedup + sync máy chi tiết: UC `FIN_019/025/030/039,CRM_050,HRM_118` →90–95 · BE 7 InMemory + FE 6 node:test · **725/1092** (66.4%) |
| 07/08/2026 | **Hoàn thiện UC dang dở BI:** refresh nguồn module thật + widget DT/LN live FIN + chạy BC filter + tải CSV/text: UC `002,008,014,016` →95 · BE 10 InMemory + FE 8 node:test · **725/1092** (66.4%) |
| 07/08/2026 | **Hoàn thiện UC dang dở SYS:** Email/SMS stub (template+IntegrationCallLog+outbox) + forgot OTP + invite user: UC `060,061,004,019` →90–95 · BE 10 InMemory + FE 7 node:test · **725/1092** (66.4%) |
