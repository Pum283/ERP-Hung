...
| Module | Tổng UC | Xong | % Xong | Số UC đã Test | % UC đã Test | Must còn |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| SYS | 104 | 91 | 87.5% | 91 | 100.0% | 0 |
| HRM | 187 | 170 | 90.9% | 170 | 100.0% | 0 |
| LMS | 74 | 43 | 58.1% | 43 | 100.0% | 0 |
| CRM | 131 | 66 | 50.4% | 66 | 100.0% | 0 |
| POS | 72 | 40 | 55.6% | 40 | 100.0% | 0 |
| PUR | 52 | 27 | 51.9% | 27 | 100.0% | 0 |
| INV | 70 | 51 | 72.9% | 51 | 100.0% | 0 |
| LOG | 39 | 26 | 66.7% | 26 | 100.0% | 0 |
| MFG | 46 | 25 | 54.3% | 25 | 100.0% | 0 |
| FSM | 50 | 28 | 56.0% | 28 | 100.0% | 0 |
| PJM | 42 | 29 | 69.0% | 29 | 100.0% | 0 |
| FIN | 83 | 53 | 63.9% | 53 | 100.0% | 0 |
| AST | 34 | 21 | 61.8% | 21 | 100.0% | 0 |
| WF | 40 | 22 | 55.0% | 22 | 100.0% | 0 |
| BI | 30 | 14 | 46.7% | 14 | 100.0% | 0 |
| PRT | 38 | 11 | 28.9% | 11 | 100.0% | 0 |
| **TỔNG** | **1.092** | **717** | **65.7%** | **717** | **100.0%** | **0** |
...
| `UC_CRM_016` | Marketing – chiến dịch | Tạo campaign marketing | Must | [x] | 80 | Batch1 Must · CrmCampaign CRUD + Entity/DTO/Controller |
...
| `UC_CRM_019` | Marketing – chiến dịch | Ghi nhận chi phí quảng cáo | Must | [x] | 80 | Batch1 Must · CrmCampaignExpense ghi nhận chi phí |
...
| `UC_CRM_023` | Marketing – chiến dịch | Đóng campaign | Must | [x] | 80 | Batch1 Must · Close campaign + snapshot metrics |
...
| `UC_CRM_026` | Marketing – nguồn & đo lường | Đồng bộ lead website / landing | Must | [x] | 80 | Batch1 Must · CrmWebLead sync UTM + form data |
...
| `UC_CRM_029` | Marketing – nguồn & đo lường | Tính CPL / CAC / ROAS / ROI | Must | [x] | 80 | Batch1 Must · CPL/CAC/ROAS/ROI marketing metrics |
| `UC_CRM_030` | Marketing – nguồn & đo lường | Funnel marketing đến doanh thu | Should | [ ] | 0 |  |
| `UC_CRM_031` | Marketing – nguồn & đo lường | Dashboard marketing | Must | [x] | 80 | Batch1 Must · Marketing dashboard aggregate |
| `UC_CRM_032` | Khuyến mại & voucher | Tạo chương trình khuyến mại | Must | [x] | 80 | Batch1 Must · CrmPromotion CRUD + conditions |
| `UC_CRM_033` | Khuyến mại & voucher | Cấu hình điều kiện khuyến mại | Must | [x] | 80 | Batch1 Must · CrmPromotionCondition config rules |
| `UC_CRM_034` | Khuyến mại & voucher | Sinh mã voucher | Must | [x] | 80 | Batch1 Must · CrmVoucher batch generate + prefix |
| `UC_CRM_035` | Khuyến mại & voucher | Giới hạn lượt dùng voucher | Must | [x] | 80 | Batch1 Must · Voucher usage limit + per customer |
| `UC_CRM_036` | Khuyến mại & voucher | Đồng bộ khuyến mại sang POS | Should | [ ] | 0 |  |
| `UC_CRM_037` | Khuyến mại & voucher | Áp dụng khuyến mại trên báo giá | Must | [x] | 80 | Batch1 Must · Apply promotion on CrmQuote |
...
| `UC_POS_054` | Đồng bộ tồn & back-office | Trừ tồn theo BOM khi bán | Must | [x] | 100 | Batch 2 · Verified CRM Sales Admin, POS BOM/Shift & PUR/LOG PO/COD APIs and tests |
| `UC_POS_055` | Đồng bộ tồn & back-office | Cảnh báo hết / sắp hết | Must | [x] | 100 | Batch 2 · Verified CRM Sales Admin, POS BOM/Shift & PUR/LOG PO/COD APIs and tests |
...
| `UC_POS_059` | Đồng bộ tồn & back-office | Đồng bộ doanh thu ca sang FIN | Must | [x] | 100 | Batch 2 · Verified CRM Sales Admin, POS BOM/Shift & PUR/LOG PO/COD APIs and tests |
...
| 06/08/2026 | Cap-2 HRM gần đủ (tuyển→chấm công→lương→KT/KL→offboard→dashboard `182–187`, skip `174`) + WF `032`/`040` · **717/1092** UC (xem `uc_progress.json` / PHAN_NHOM_UC_CAC_MODULE.md) |
