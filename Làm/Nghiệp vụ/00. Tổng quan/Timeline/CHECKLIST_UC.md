...
| `UC_HRM_015` | Hồ sơ nhân sự                    | NV tự cập nhật hồ sơ                | Should  | [ ]   |   0 |                                           |
| `UC_HRM_016` | Hồ sơ nhân sự                    | Upload ảnh đại diện                 | Could   | [ ]   |   0 |                                           |
...
| `UC_HRM_020` | Hồ sơ nhân sự                    | Gắn chức danh / level               | Must    | [x]   | 100 | M1 · title/level                          |
| `UC_HRM_021` | Hồ sơ nhân sự                    | Gắn loại nhân sự                    | Must    | [x]   | 100 | M1 · employee type                        |
| `UC_HRM_022` | Hồ sơ nhân sự                    | Gắn nhiều nhãn hồ sơ                | Should  | [ ]   |   0 |                                           |
...
| `UC_HRM_025` | Hồ sơ nhân sự                    | Tìm kiếm nhân sự đa tiêu chí        | Must    | [x]   |  90 | M1 · list q=                              |
...
| `UC_HRM_030` | Trạng thái & biến động nhân sự   | Chuyển trạng thái Chính thức        | Must    | [x]   |  80 | N1 · org/status/code/export/HĐ Day-1      |
| `UC_HRM_031` | Trạng thái & biến động nhân sự   | Chuyển trạng thái Tạm nghỉ          | Should  | [ ]   |   0 |                                           |
...
| `UC_HRM_035` | Trạng thái & biến động nhân sự   | Thăng chức / đổi chức danh          | Must    | [x]   |  80 | N1 · org/status/code/export/HĐ Day-1      |
...
| `UC_HRM_040` | Hợp đồng lao động                | Upload bản scan hợp đồng            | Must    | [x]   |  80 | N1 · org/status/code/export/HĐ Day-1      |
| `UC_HRM_041` | Hợp đồng lao động                | Gia hạn hợp đồng                    | Must    | [x]   |  80 | N1 · org/status/code/export/HĐ Day-1      |
| `UC_HRM_042` | Hợp đồng lao động                | Thanh lý / chấm dứt hợp đồng        | Must    | [x]   |  80 | N1 · org/status/code/export/HĐ Day-1      |
...
| `UC_HRM_045` | Hợp đồng lao động                | Quản lý lương hợp đồng              | Must    | [x]   |  80 | N1 · org/status/code/export/HĐ Day-1      |
...
| `UC_LMS_010` | Ngân hàng câu hỏi & đề thi | Tạo ngân hàng câu hỏi                   | Must    | [x]   |  85 | L2 · LmsQuestion NHCH + /app/lms/exams                |
| `UC_LMS_011` | Ngân hàng câu hỏi & đề thi | Phân loại câu hỏi theo độ khó           | Should  | [ ]   |   0 |                                                       |
| `UC_LMS_012` | Ngân hàng câu hỏi & đề thi | Tạo đề thi cố định                      | Must    | [x]   |  85 | L2 · đề cố định ExamQuestion                          |
...
| `UC_LMS_020` | Lớp Offline                | Ghi nhận học phí                        | Should  | [ ]   |   0 |                                                       |
| `UC_LMS_021` | Lớp Offline                | Đánh giá thực hành tại lớp              | Should  | [ ]   |   0 |                                                       |
...
| `UC_LMS_025` | Mentoring                  | Mentor ghi nhận tiến độ                 | Should  | [ ]   |   0 |                                                       |
...
| `UC_LMS_058` | Khảo sát & xác nhận        | Xác nhận đã đọc nội quy                 | Must    | [ ]   |   0 |                                                       |
...
| `UC_CRM_016` | Marketing – chiến dịch       | Tạo campaign marketing            | Must    | [ ]   |   0 |                                                 |
...
| `UC_CRM_019` | Marketing – chiến dịch       | Ghi nhận chi phí quảng cáo        | Must    | [ ]   |   0 |                                                 |
...
| `UC_CRM_023` | Marketing – chiến dịch       | Đóng campaign                     | Must    | [ ]   |   0 |                                                 |
...
| `UC_CRM_026` | Marketing – nguồn & đo lường | Đồng bộ lead website / landing    | Must    | [ ]   |   0 |                                                 |
...
| `UC_CRM_029` | Marketing – nguồn & đo lường | Tính CPL / CAC / ROAS / ROI       | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_030` | Marketing – nguồn & đo lường | Funnel marketing đến doanh thu    | Should  | [ ]   |   0 |                                                 |
| `UC_CRM_031` | Marketing – nguồn & đo lường | Dashboard marketing               | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_032` | Khuyến mại & voucher         | Tạo chương trình khuyến mại       | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_033` | Khuyến mại & voucher         | Cấu hình điều kiện khuyến mại     | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_034` | Khuyến mại & voucher         | Sinh mã voucher                   | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_035` | Khuyến mại & voucher         | Giới hạn lượt dùng voucher        | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_036` | Khuyến mại & voucher         | Đồng bộ khuyến mại sang POS       | Should  | [ ]   |   0 |                                                 |
| `UC_CRM_037` | Khuyến mại & voucher         | Áp dụng khuyến mại trên báo giá   | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_038` | Khuyến mại & voucher         | Báo cáo sử dụng voucher           | Should  | [ ]   |   0 |                                                 |
...
| `UC_CRM_047` | Omnichannel & chatbot        | Lưu lịch sử chat                  | Must    | [ ]   |   0 |                                                 |
...
| `UC_CRM_074` | Báo giá                      | Gửi báo giá PDF/email             | Must    | [x]   |  80 | L2 · gửi báo giá Email/PDF stub                 |
...
| `UC_CRM_082` | Sales Online / đơn hàng      | Giữ tồn khi duyệt đơn             | Must    | [x]   |  75 | L2 · giữ tồn stub (StockHoldStatus)             |
...
| `UC_CRM_088` | Sales Online / đơn hàng      | Đẩy đơn sang kho / giao vận       | Must    | [x]   |  75 | L2 · đẩy kho/LOG stub                           |
...
| `UC_CRM_099` | Sales Admin                  | Hàng đợi đơn cần xử lý            | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_100` | Sales Admin                  | Kiểm tra tồn / xác nhận giữ hàng  | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_101` | Sales Admin                  | Soạn lệnh xuất / giao             | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_102` | Sales Admin                  | Đối soát chứng từ đơn             | Should  | [ ]   |   0 |                                                 |
| `UC_CRM_103` | Sales Admin                  | Xử lý khiếu nại đơn hàng          | Should  | [ ]   |   0 |                                                 |
| `UC_CRM_104` | Sales Admin                  | Theo dõi đơn chậm xử lý           | Must    | [ ]   |   0 |                                                 |
...
| `UC_CRM_109` | Hợp đồng & chính sách bán    | Chính sách giá theo nhóm KH       | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_110` | Hợp đồng & chính sách bán    | Chính sách công nợ / hạn mức      | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_111` | Hợp đồng & chính sách bán    | Chặn bán khi vượt công nợ         | Should  | [ ]   |   0 |                                                 |
| `UC_CRM_112` | Chăm sóc khách hàng          | Tạo ticket hỗ trợ                 | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_113` | Chăm sóc khách hàng          | Phân loại khiếu nại / yêu cầu     | Must    | [ ]   |   0 |                                                 |
...
| `UC_CRM_124` | Hoa hồng & KPI sales         | KPI doanh số theo nhân viên       | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_125` | Hoa hồng & KPI sales         | Bảng xếp hạng sales               | Could   | [ ]   |   0 |                                                 |
| `UC_CRM_126` | Báo cáo CRM                  | Dashboard Ban lãnh đạo sales      | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_127` | Báo cáo CRM                  | Báo cáo pipeline & forecast       | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_128` | Báo cáo CRM                  | Báo cáo theo nguồn / campaign     | Must    | [ ]   |   0 |                                                 |
| `UC_CRM_129` | Báo cáo CRM                  | Báo cáo theo nhân viên / vùng     | Must    | [ ]   |   0 |                                                 |
...
| `UC_POS_015` | Catalog bán hàng             | Đồng bộ catalog từ back-office       | Must    | [x]   |  75 | L2 · sync stamp back-office (stub)           |
...
| `UC_POS_037` | Giao dịch bán hàng           | In hóa đơn                           | Must    | [x]   |  75 | L2 · in hóa đơn stub                         |
...
| `UC_POS_048` | Ca thu ngân & quỹ            | In báo cáo ca                        | Must    | [x]   |  75 | L2 · in báo cáo ca stub                      |
...
| `UC_POS_054` | Đồng bộ tồn & back-office    | Trừ tồn theo BOM khi bán             | Must    | [ ]   |   0 |                                              |
| `UC_POS_055` | Đồng bộ tồn & back-office    | Cảnh báo hết / sắp hết               | Must    | [ ]   |   0 |                                              |
...
| `UC_POS_059` | Đồng bộ tồn & back-office    | Đồng bộ doanh thu ca sang FIN        | Must    | [ ]   |   0 |                                              |
...
| `UC_POS_065` | Báo cáo POS                  | Cost lý thuyết vs thực tế            | Should  | [ ]   |   0 |                                              |
| `UC_POS_066` | Báo cáo POS                  | Top sản phẩm bán chạy                | Should  | [ ]   |   0 |                                              |
| `UC_POS_067` | Báo cáo POS                  | So sánh điểm bán                     | Should  | [ ]   |   0 |                                              |
| `UC_POS_068` | Báo cáo POS                  | Xuất báo cáo POS                     | Must    | [x]   |  90 | L2 · xuất CSV báo cáo POS                    |
| `UC_POS_069` | Vận hành chuỗi               | Giám sát doanh thu chuỗi realtime    | Should  | [ ]   |   0 |                                              |
| `UC_POS_070` | Vận hành chuỗi               | Phân phối catalog / giá / khuyến mại | Must    | [ ]   |   0 |                                              |
| `UC_POS_071` | Vận hành chuỗi               | Chuẩn hóa catalog toàn chuỗi         | Must    | [ ]   |   0 |                                              |
| `UC_POS_072` | Vận hành chuỗi               | Cấu hình target doanh thu            | Should  | [ ]   |   0 |                                              |
...
| `UC_PUR_010` | Nguồn cung & giá mua              | Bảng giá mua theo nhà cung cấp       | Must    | [x]   |  85 | L2 · VendorPrice bảng giá mua       |
...
| `UC_PUR_015` | Yêu cầu mua hàng (PR)             | Tạo PR từ cảnh báo tồn min           | Should  | [ ]   |   0 |                                     |
...
| `UC_PUR_020` | Yêu cầu mua hàng (PR)             | Hủy PR                               | Should  | [ ]   |   0 |                                     |
...
| `UC_PUR_025` | Báo giá & chọn nhà cung cấp (RFQ) | Chuyển RFQ thành PO                  | Should  | [ ]   |   0 |                                     |
...
| `UC_PUR_033` | Đơn mua hàng (PO)                 | In / xuất PO                         | Must    | [x]   |  75 | L2 · in/xuất PO stub                |
...
| `UC_PUR_037` | Nhận hàng & trả nhà cung cấp      | Đẩy nhập kho sang INV                | Must    | [x]   |  75 | L2 · đẩy INV stub                   |
...
| `UC_PUR_043` | Hóa đơn mua & đối soát            | Đẩy công nợ sang FIN AP              | Must    | [x]   |  75 | L2 · đẩy AP stub                    |
...
| `UC_INV_010` | Danh mục sản phẩm           | Định mức tồn min/max/reorder      | Must    | [x]   |  85 | L2 · Min/Max/Reorder                     |
| `UC_INV_011` | Cấu hình kho & vị trí       | Tạo kho                           | Must    | [x]   |  85 | L2 · InvWarehouse + FE warehouses        |
| `UC_INV_012` | Cấu hình kho & vị trí       | Loại kho                          | Must    | [x]   |  85 | L2 · InvWarehouseType                    |
...
| `UC_INV_018` | Nhập kho                    | Nhập từ sản xuất                  | Must    | [ ]   |   0 |                                          |
| `UC_INV_019` | Nhập kho                    | Nhập điều chỉnh / kiểm kê         | Must    | [x]   |  85 | L2 · nhập điều chỉnh / KK                |
| `UC_INV_020` | Nhập kho                    | Nhập chuyển đến                   | Must    | [ ]   |   0 |                                          |
...
| `UC_INV_024` | Xuất kho                    | Xuất bán / giao hàng              | Must    | [ ]   |   0 |                                          |
| `UC_INV_025` | Xuất kho                    | Xuất sản xuất                     | Must    | [ ]   |   0 |                                          |
...
| `UC_INV_036` | Chuyển kho                  | Chuyển từ kho trung tâm           | Must    | [ ]   |   0 |                                          |
...
| `UC_INV_040` | Giữ hàng & tồn khả dụng     | Xem tồn khả dụng                  | Must    | [x]   |  80 | L2 · tồn khả dụng = onhand-reserved      |
...
| `UC_INV_061` | Giá trị kho & kế toán kho   | Tính lại giá vốn                  | Must    | [ ]   |   0 |                                          |
| `UC_INV_062` | Giá trị kho & kế toán kho   | Đẩy bút toán kho sang FIN         | Must    | [ ]   |   0 |                                          |
...
| `UC_LOG_010` | Lệnh giao hàng       | Xác nhận xuất hàng giao              | Must    | [x]   |  85 | L2 · Dispatch xuất hàng                         |
...
| `UC_LOG_015` | Điều phối & theo dõi | Tracking mã vận đơn                  | Could   | [ ]   |   0 |                                                 |
...
| `UC_LOG_020` | COD                  | Đánh dấu đơn thu COD                 | Must    | [x]   |  90 | L2 · MarkCod IsCod+Pending trên lệnh giao       |
...
| `UC_LOG_025` | COD                  | Cảnh báo COD quá hạn                 | Must    | [x]   |  90 | L2 · CodOverdue + /cod/overdue                  |
...
| `UC_LOG_030` | Hoàn hàng & giao lại | Chi phí phát sinh hoàn               | Could   | [ ]   |   0 |                                                 |
...
| `UC_MFG_010` | BOM & định mức      | So sánh phiên bản BOM                | Could   | [ ]   |   0 |                                            |
...
| `UC_MFG_015` | Kế hoạch sản xuất   | Đề xuất mua nguyên vật liệu thiếu    | Should  | [ ]   |   0 |                                            |
...
| `UC_MFG_020` | Lệnh sản xuất       | Xuất nguyên vật liệu cho lệnh        | Must    | [x]   |  85 | L2 · MaterialIssue                         |
...
| `UC_MFG_031` | Giá thành sản xuất  | Đẩy giá thành sang INV/FIN           | Must    | [x]   |  90 | L2 · đẩy StandardCost INV + JE WIP→TP stub |
...
| `UC_FSM_010` | Install base – thiết bị tại khách | Lịch sử bảo hành / sửa chữa        | Must    | [x]   |  85 | L2 · FsmAssetHistory                       |
...
| `UC_FSM_015` | Tiếp nhận & phân công ticket      | Phân công kỹ thuật viên thủ công   | Must    | [x]   |  85 | L2 · Assign technician                     |
...
| `UC_FSM_019` | Tiếp nhận & phân công ticket      | Xác nhận lịch trên APP             | Must    | [ ]   |   0 |                                            |
| `UC_FSM_020` | Thực hiện hiện trường             | Check-in hiện trường GPS           | Should  | [ ]   |   0 |                                            |
...
| `UC_FSM_041` | APP kỹ thuật viên                 | Danh sách việc hôm nay             | Must    | [ ]   |   0 |                                            |
| `UC_FSM_042` | APP kỹ thuật viên                 | Điều hướng / thông tin khách       | Must    | [ ]   |   0 |                                            |
...
| `UC_PJM_010` | Khởi tạo dự án            | Phê duyệt khởi động            | Should  | [ ]   |   0 |                                         |
...
| `UC_PJM_015` | Kế hoạch & tiến độ        | Phụ thuộc giữa hạng mục        | Could   | [ ]   |   0 |                                         |
...
| `UC_FIN_015` | Sổ cái & bút toán            | Nhận bút toán tự động           | Must    | [x]   |  80 | L2 · BT tự động stub (Source=Auto)                   |
| `UC_FIN_016` | Sổ cái & bút toán            | Kiểm soát bút toán lệch Nợ/Có   | Must    | [ ]   |   0 |                                                      |
...
| `UC_FIN_062` | Doanh thu & giá vốn          | Chiết khấu làm giảm doanh thu   | Must    | [ ]   |   0 |                                                      |
| `UC_FIN_063` | Chi phí & phân bổ            | Ghi nhận chi phí hoạt động      | Must    | [ ]   |   0 |                                                      |
| `UC_FIN_064` | Chi phí & phân bổ            | Phân bổ chi phí                 | Should  | [ ]   |   0 |                                                      |
| `UC_FIN_065` | Chi phí & phân bổ            | Chi phí lương từ HRM            | Must    | [ ]   |   0 |                                                      |
...
| `UC_FIN_068` | Kết chuyển & khóa sổ         | Kết chuyển lãi/lỗ cuối kỳ       | Must    | [ ]   |   0 |                                                      |
| `UC_FIN_069` | Kết chuyển & khóa sổ         | Đối chiếu công nợ – sổ cái      | Must    | [ ]   |   0 |                                                      |
| `UC_FIN_070` | Kết chuyển & khóa sổ         | Checklist khóa sổ tháng         | Should  | [ ]   |   0 |                                                      |
| `UC_FIN_071` | Kết chuyển & khóa sổ         | Khóa sổ năm tài chính           | Must    | [ ]   |   0 |                                                      |
...
| `UC_FIN_076` | Báo cáo tài chính & quản trị | Bảng cân đối phát sinh          | Must    | [ ]   |   0 |                                                      |
| `UC_FIN_077` | Báo cáo tài chính & quản trị | Báo cáo P&L quản trị            | Must    | [ ]   |   0 |                                                      |
| `UC_FIN_078` | Báo cáo tài chính & quản trị | Bảng cân đối kế toán            | Must    | [ ]   |   0 |                                                      |
| `UC_FIN_079` | Báo cáo tài chính & quản trị | Báo cáo lưu chuyển tiền tệ      | Must    | [ ]   |   0 |                                                      |
| `UC_FIN_080` | Báo cáo tài chính & quản trị | P&L theo chi nhánh / đơn vị     | Must    | [ ]   |   0 |                                                      |
| `UC_FIN_081` | Báo cáo tài chính & quản trị | Báo cáo công nợ tổng hợp        | Must    | [ ]   |   0 |                                                      |
| `UC_FIN_082` | Báo cáo tài chính & quản trị | Dashboard tài chính             | Must    | [ ]   |   0 |                                                      |
| `UC_FIN_083` | Báo cáo tài chính & quản trị | Xuất báo cáo tài chính          | Must    | [ ]   |   0 |                                                      |
...
| `UC_AST_010` | Khấu hao                   | Tính khấu hao định kỳ                | Must    | [x]   |  85 | L2 · tính KH định kỳ StraightLine/DB            |
| `UC_AST_011` | Khấu hao                   | Xem sổ khấu hao                      | Must    | [x]   |  85 | L2 · sổ KH theo kỳ (run/lines)                  |
| `UC_AST_012` | Khấu hao                   | Đẩy bút toán khấu hao sang FIN       | Must    | [x]   |  80 | L2 · đẩy FIN stub (JE Auto hoặc mark Pushed)    |
...
| `UC_AST_015` | Ghi tăng – ghi giảm        | Ghi tăng từ xây dựng                 | Could   | [ ]   |   0 |                                                 |
...
| `UC_AST_020` | Ghi tăng – ghi giảm        | Đánh giá lại nguyên giá              | Won't   | [ ]   |   0 |                                                 |
...
| `UC_WF_031` | Thực thi phê duyệt            | Duyệt trên mobile APP               | Must    | [ ]   |   0 |                                      |
...
| `UC_BI_010` | Dashboard quản trị       | Widget nhân sự – công          | Should  | [ ]   |   0 |                                                         |
...
| `UC_BI_015` | Thư viện báo cáo chuẩn   | Lưu bộ lọc / yêu thích         | Should  | [ ]   |   0 |                                                         |
...
| 05/08/2026 | Cap-2 INV FEFO/giữ hàng/HSD `029,037–038,042–045,048` · **638/1092** UC (xem `uc_progress.json` / PHAN_NHOM_UC_CAC_MODULE.md) |
