...
| -------- | --------: | ------: | ----: | ------: | --------: | -------: | -------: | ---------: | -------: | -------: | -------: | ------------------------------------------------------------------------------------ |
| SYS      |       104 |      91 |     0 |      13 |     87.5% |       59 |        0 |          2 |       11 |     91.8 |       10 | Cao hơn Day-1; Email/SMS stub+IntegrationCallLog wired; 2FA/trusted-device còn Dev   |
...
| CRM      |       131 |      68 |     0 |      63 |     51.9% |       66 |        0 |         52 |       11 |     89.2 |        7 | Auto-intake + báo giá Email/PDF text thật + marketing Cap-2; còn Should omni         |
...
| BI       |        30 |      14 |     0 |      16 |     46.7% |       12 |        0 |         10 |        6 |     91.1 |        3 | KPI actual còn stub một phần; dataset/widget/export Cap-2 đã live                    |
| PRT      |        38 |      11 |     0 |      27 |     28.9% |       11 |        0 |         12 |       15 |     85.0 |        3 | Login/forgot stub; portal mỏng (~3 trang)                                            |
| **TỔNG** | **1.092** | **724** | **0** | **368** | **66.3%** |  **616** |    **0** |    **282** |   **86** | **88.1** |   **99** | Xem [`Rà xoát UC.md`](./Rà%20xoát%20UC.md)                                           |
...
| 07/08/2026    | **Hoàn thiện UC dang dở FIN/CRM/HRM:** JE thu·NH·AR·AP luôn thật + auto-intake dedup + sync máy chi tiết: UC `FIN_019/025/030/039,CRM_050,HRM_118` →90–95 · BE 7 InMemory + FE 6 node:test · **724/1092** (66.3%) |
| 07/08/2026    | **Hoàn thiện UC dang dở BI:** refresh nguồn module thật + widget DT/LN live FIN + chạy BC filter + tải CSV/text: UC `002,008,014,016` →95 · BE 10 InMemory + FE 8 node:test · **724/1092** (66.3%)                |
| 07/08/2026    | **Hoàn thiện UC dang dở SYS:** Email/SMS stub (template+IntegrationCallLog+outbox) + forgot OTP + invite user: UC `060,061,004,019` →90–95 · BE 10 InMemory + FE 7 node:test · **724/1092** (66.3%)               |
